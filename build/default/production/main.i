...
void generate_apple(uint8_t *x, uint8_t *y, Pos *pos, uint8_t len);
void handle_game_over();
void hand_game_start();
void notice_to_music(int type);
_Bool check_apple_eaten(uint8_t apple_x, uint8_t apple_y, Pos *pos);
# 10 "main.c" 2
